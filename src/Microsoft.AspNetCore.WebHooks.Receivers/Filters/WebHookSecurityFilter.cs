...
namespace Microsoft.AspNetCore.WebHooks.Filters
{
    ...
    public abstract class WebHookSecurityFilter
    {
        ...
        /// <summary>
        /// Gets the <see cref="IConfigurationRoot"/> for the application.
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        /// This method allows non-HTTP requests while the application is in development or if the
        ...
        protected virtual IConfigurationSection GetSecretKeys(string sectionKey, RouteData routeData)
        {
            ...
            // Look up configuration for this receiver and instance
            var secrets = Configuration.GetSecretKeys(sectionKey, id);
            if (secrets == null)
            {
                if (!Configuration.HasSecretKeys(sectionKey))
                {
