...
namespace Microsoft.AspNetCore.WebHooks
{
    ...
    public static class WebHookConstants
    {
        ...
        /// <summary>
        /// Gets the names of the <see cref="AspNetCore.Routing.RouteValueDictionary"/> entries containing event names
        /// for the current request when there are more than one event name.
        /// </summary>
        /// <seealso cref="Metadata.IWebHookEventMetadata"/>
        public static string[] EventKeyNames { get; } = Enumerable.Range(0, 100)
            .Select(i => $"{EventKeyName}[{i}]")
            .ToArray();
